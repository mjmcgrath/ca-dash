        ...
        //try {
            this.lazyItems = new LazyDataModel<Activity>(){
                ...
                public List<Activity> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, String> filters) {
                    ...
                    List<Activity> result = getFacade().getResultList(first, pageSize, sortField, sortOrder, filters);
                    lazyItems.setRowCount(getFacade().count(sortField, sortOrder, filters));
                    return result;
                }
            };
        }
